...
storiesOf("Button", module)
  ...
  storiesOf("InterviewerList", module)
    ...
    .add("Show", () => <Show interviewer={interviewers[0]} student={"Connor Mackay"}  onEdit={action("onEdit")} onDelete={action('onDelete')} />)
    ...
    .add("Edit", () => <Form name={"Connor Mackay"} interviewers={interviewers} interviewer={3} onSave={action("onSave")} onCancel={action("onCancel")} />)
